...
public final class Constants {
  ...
  public static final class PWM {
    ...
    public static final int launchRight = 7;//TODO:Check this!!!
  ...
  public static final class PCM1 {
    ...
    public static final int launchForward = 0;
    public static final int launchReverse = 1;
    public static final int transferReverse = 2;
    public static final int transferForward = 3;
